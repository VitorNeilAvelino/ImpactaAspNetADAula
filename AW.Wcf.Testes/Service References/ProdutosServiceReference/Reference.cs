...
namespace AW.Wcf.Testes.ProdutosServiceReference {
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="Product", Namespace="http://schemas.datacontract.org/2004/07/AW.Repositorios.SqlServer.EF.DbFirst")]
    ...
    public interface IProdutos {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IProdutos/Selecionar", ReplyAction="http://tempuri.org/IProdutos/SelecionarResponse")]
        AW.Wcf.Testes.ProdutosServiceReference.Product Selecionar(int value);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IProdutos/Selecionar", ReplyAction="http://tempuri.org/IProdutos/SelecionarResponse")]
        System.Threading.Tasks.Task<AW.Wcf.Testes.ProdutosServiceReference.Product> SelecionarAsync(int value);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IProdutos/SelecionarPorNome", ReplyAction="http://tempuri.org/IProdutos/SelecionarPorNomeResponse")]
        AW.Wcf.Testes.ProdutosServiceReference.Product[] SelecionarPorNome(string nome);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IProdutos/SelecionarPorNome", ReplyAction="http://tempuri.org/IProdutos/SelecionarPorNomeResponse")]
        System.Threading.Tasks.Task<AW.Wcf.Testes.ProdutosServiceReference.Product[]> SelecionarPorNomeAsync(string nome);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IProdutosChannel : AW.Wcf.Testes.ProdutosServiceReference.IProdutos, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ProdutosClient : System.ServiceModel.ClientBase<AW.Wcf.Testes.ProdutosServiceReference.IProdutos>, AW.Wcf.Testes.ProdutosServiceReference.IProdutos {
        ...
        public AW.Wcf.Testes.ProdutosServiceReference.Product Selecionar(int value) {
            return base.Channel.Selecionar(value);
        }
        
        public System.Threading.Tasks.Task<AW.Wcf.Testes.ProdutosServiceReference.Product> SelecionarAsync(int value) {
            return base.Channel.SelecionarAsync(value);
        }
        
        public AW.Wcf.Testes.ProdutosServiceReference.Product[] SelecionarPorNome(string nome) {
            return base.Channel.SelecionarPorNome(nome);
        }
        
        public System.Threading.Tasks.Task<AW.Wcf.Testes.ProdutosServiceReference.Product[]> SelecionarPorNomeAsync(string nome) {
            return base.Channel.SelecionarPorNomeAsync(nome);
        }
    }
}
